This is a simple HTML exercise from the Odin Project wherein I create a homepage and three different recipe pages. The homepage links to each recipe and each recipe has a link to the homepage.
